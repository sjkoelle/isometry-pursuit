...
Selection of coordinate functions of an embedding space from within a dictionary is a core problem in geometric data analysis .
...
% In could be used in the stiching step of an algorithm like the kohli one
