...
%Such a dictionary may also be constructed out of non-interpretable features \cite{Kohli2021-lr}.
...
% cite anthropic functional independence.
...
Approaches that seek isometric embeddings non-parametrically include Local Tangent Space Alignment, multidimensional scaling and isomap. % cite
