...
% NOTE (Sam) is it just q(v) = g^{-1} (\|v\|) v/\|v\| basically?
...
This is summarized in the following proposition, which is slightly stronger than Proposition \label{prop:unitary_selection}
 
\subsection{Isometric lasso}

We defer discussion of computational complexity to Section \ref{sec:computational_complexity}.
