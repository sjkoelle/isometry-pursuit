...
This proof proceeds by showing that replacing $X_{.S(\beta)}$ with a unitary matrix - without loss of generality $I_D$ - leads to the existence of a solution $\beta_S' = X_S \beta_S = \beta$ such that $\|\beta_S\|_{1,2} \leq \|\beta_S' \|_{1,2}$.
