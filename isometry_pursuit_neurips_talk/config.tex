...
\setbeamercolor{pink}{bg=pink}
\setbeamercolor{turquoise}{bg=teal}
\setbeamercolor{orange}{bg=violet}
\captionsetup[subfigure]{labelformat=empty}

\setbeamercolor{author}{bg=beamer@blendedblue,fg=white}
\setbeamercolor{institute}{bg=beamer@blendedblue,fg=white}
\setbeamercolor{date}{bg=beamer@blendedblue,fg=white}
